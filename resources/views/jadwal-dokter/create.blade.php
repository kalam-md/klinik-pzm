      ...
      <div class="card mb-6">
        ...
        <div class="card-body">
          <form action="{{ route('jadwal-dokter.store') }}" method="POST">
            ...
            <div class="form-floating form-floating-outline mb-6">
              <input type="time" class="form-control" id="basic-default-jam_mulai" name="jam_mulai" required />
              <label for="basic-default-jam_mulai">Jam Mulai</label>
            </div>
            <div class="form-floating form-floating-outline mb-6">
              <input type="time" class="form-control" id="basic-default-jam_selesai" name="jam_selesai" required />

        ...
        <div class="card-body">
          <form action="{{ route('dokter.store') }}" method="POST">
            ...
            <div class="form-floating form-floating-outline mb-6">
              <input type="text" class="form-control" id="basic-default-nama_dokter" name="nama_dokter" required />
            ...
            <div class="form-floating form-floating-outline mb-6">
              <input type="text" class="form-control" id="basic-default-spesialis" name="spesialis" required />
              <label for="basic-default-spesialis">Spesialis</label>
            </div>
            <div class="form-floating form-floating-outline mb-6">
              <input type="number" class="form-control" id="basic-default-nomor_telepon" name="nomor_telepon" required />
              <label for="basic-default-nomor_telepon">Nomor Telepon</label>
            </div>
            <div class="form-floating form-floating-outline mb-6">
              <input type="email" class="form-control" id="basic-default-email" name="email" required />
